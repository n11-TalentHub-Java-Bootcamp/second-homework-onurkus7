...
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	1	,'Therefore, database queries may be performed during view rendering.',now(), 777,1);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	2	,'Using JtaPlatform implementation.',now(), 555,2);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	3	,'Started SpringBootTraningApplication in 5.506 seconds.',now(), 444,3);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	4	,'tarting SpringBootTraningApplication using Java 11.0.13 on DESKTOP',now(),333,4);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	5	,'Therefore, database queries may be performed during view rendering.',now(), 222,5);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	6	,'Therefore, database queries may be performed during view rendering.',now(), 666,6);
INSERT INTO PRODUCT_REVIEW( ID, REVIEW, REVIEW_DATE, ID_PRODUCT_REVIEW, ID_USERS) VALUES (	7	,'Therefore, database queries may be performed during view rendering.',now(),  999,7);
